...
#define DefaultCellHeight 400
@interface  EditFitmentPriceVC()<HZCaseDetailFooterCellDelegate,EditFitmentCollectionViewCellDelegate,HZCaseDetailImageCellDelegate,UICollectionViewDelegate,UICollectionViewDelegateFlowLayout,UICollectionViewDataSource,CLImageEditorDelegate>
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (model.type == ModelSectionTypeNomal) {
        if (indexPath.item == 0) {
            ...
            cell.caseNum.text = [NSString stringWithFormat:@"报价%@ :",stringNumber];
