...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    if (_isDropTabView) {
        ...
        if (indexPath.row>0) {
            YuyueDetailVC *vc=[[YuyueDetailVC alloc]initWithNibName:@"YuyueDetailVC" bundle:nil];
            YueyueDataModel *model=[self.dataArr objectAtIndex:indexPath.row-1];
            vc.yuyueId=model.yuyueId;
