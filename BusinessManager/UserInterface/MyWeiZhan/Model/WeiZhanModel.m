...
@implementation YuyueDeatailModel
- (instancetype)init{
    if (self=[super init]) {
        [YuyueDeatailModel mj_setupObjectClassInArray:^NSDictionary *{
            return @{@"data" : @"YueyueDeatailData"};
        }];
    }
    return self;
}
...
@implementation YueyueDeatailData
