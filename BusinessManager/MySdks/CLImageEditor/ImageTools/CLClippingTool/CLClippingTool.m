...
+ (NSArray*)defaultPresetRatios
{
    return @[
             ...
             @{kCLClippingToolRatioValue1:@138, kCLClippingToolRatioValue2:@690, kCLClippingToolRatioTitleFormat:@"%g : %g"},
             @{kCLClippingToolRatioValue1:@234, kCLClippingToolRatioValue2:@750, kCLClippingToolRatioTitleFormat:@"%g : %g"},
             @{kCLClippingToolRatioValue1:@750, kCLClippingToolRatioValue2:@278, kCLClippingToolRatioTitleFormat:@"%g : %g"},
             @{kCLClippingToolRatioValue1:@640, kCLClippingToolRatioValue2:@960, kCLClippingToolRatioTitleFormat:@"%g : %g"},
             ];
...
//    _gridView.gridColor = [[UIColor darkGrayColor] colorWithAlphaComponent:0.8];
    ...
    _gridView.clippingRatio = self.clipRatio;
...
//            ratio.isLandscape = (val1 > val2);
            ...
            ratio.isLandscape=YES;
//            ratio.isLandscape = (imgSize.height > imgSize.width);
        }
