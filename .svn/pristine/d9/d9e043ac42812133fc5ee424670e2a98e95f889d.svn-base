...
-(void)UI{
    ...
    _textView.placeholder = @"请输入您装修案例的介绍,如果没有图片,可不上传";
...
-(void)upLoadContent{
    ...
    if (!self.model) {
        ...
        model.templateModelname = @"更多案例";
        model.templateModelnameCode = MoreCase;
