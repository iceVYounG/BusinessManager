...
//        _imageView.contentMode = UIViewContentModeScaleAspectFill;
        ...
        _titleLabel=[[UILabel alloc]initWithFrame:CGRectMake(7, self.bounds.size.height-20, self.bounds.size.width, 20)];
        _titleLabel.font=[UIFont systemFontOfSize:11];
        _titleLabel.backgroundColor=[UIColor clearColor];
        _titleLabel.textColor=[UIColor colorWithHexString:@"#cbcbcb"];
...
- (void)layoutSubviews {
   ...
   _imageView.frame=CGRectMake(0, 0, self.bounds.size.width, self.bounds.size.height-20);
