...
- (void)clickVerifyBtn{
    ...
    [[MallNetworkEngine vipCardMGshare]requestNotEncodeWithDate:nil requestWithPath:API_Scan Params:params CompletionHandler:^(MKNetworkOperation *completedOperation) {
        ...
        VerifyDetailViewController *verifyDetailVC = [[VerifyDetailViewController alloc]init];
        verifyDetailVC.userMobile = _verifyTF.text;
        verifyDetailVC.dataDic = dic;
        [self.navigationController pushViewController:verifyDetailVC animated:YES];
