...
- (void)setupMainView
{
    ...
    [mainView registerClass:[SDCollectionViewCell class] forCellWithReuseIdentifier:SDID];
...
- (void)setupPageControl
{
    ...
    if (self.imagesGroup.count==1) {//add by nada;
...
{
    SDCollectionViewCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:SDID forIndexPath:indexPath];
